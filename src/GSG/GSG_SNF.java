...
public class GSG_SNF extends GSG {
	...
	private Float calcul_utilite(int indice_joueur,ArrayList<Integer> choix_des_joueurs) {
		...
		if (indice_joueur < this.nb_attacker) {
			...
			default :
				System.out.println("Le calcul d'utilit� concernant les braconniers n'existe pas");
				break;
			}			
		}
		...
		// cas o� le joueur est un garde_chasse
			...
			default :
				...
				System.out.println("Le calcul d'utilit� concernant les gardes chasses n'existe pas");
				break;
